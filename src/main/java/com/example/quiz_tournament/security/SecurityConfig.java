...
public class SecurityConfig {
    ...
    // Remove AuthTokenFilter from constructor and autowire it separately
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/player/**").hasAuthority("ROLE_PLAYER")// Explicit player role requirement
